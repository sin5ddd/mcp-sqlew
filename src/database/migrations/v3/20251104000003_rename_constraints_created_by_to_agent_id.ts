/**
 * Converted from: src/config/knex/enhancements/20251104000003_rename_constraints_created_by_to_agent_id.ts
 * Line count: 208 → 208 (0% reduction)
 *
 * No wrapper needed - Complex migration with column renaming and view recreation.
 * The wrapper doesn't provide column rename functionality, so keeping original logic.
 *
