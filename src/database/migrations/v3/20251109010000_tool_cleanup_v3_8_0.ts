/**
 * Converted from: src/config/knex/enhancements/20251109010000_tool_cleanup_v3_8_0.ts
 * Line count: 395 → 395 (0% reduction)
 *
 * No wrapper needed - Pure data seeding migration (help system metadata updates)
 *
