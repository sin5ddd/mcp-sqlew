/**
 * Converted from: src/config/knex/enhancements/20251106000000_fix_master_tables_project_id_v3_7_3.ts
 * Line count: 662 → 662 (0% reduction)
 *
 * No wrapper needed - Extremely complex migration with table recreation, data migration,
 * FK constraint handling, view management, and multi-step data consolidation.
 * The wrapper doesn't provide enough abstraction for this level of complexity.
 *
