/**
 * Converted from: src/config/knex/enhancements/20251025120000_add_cascade_to_task_dependencies.ts
 * Changes: None (complex SQLite-specific table recreation - no wrapper benefit)
 * Line count: 89 → 89 lines (0% reduction)
 */
