...
export function fileHelp(): any {
  return {
    ...
    examples: {
      record: '{ action: "record", file_path: "src/index.ts", change_type: "modified", layer: "infrastructure" }',
      get: '{ action: "get", layer: "infrastructure", limit: 10 }',
      check_lock: '{ action: "check_lock", file_path: "src/index.ts", lock_duration: 300 }',
      record_batch: '{ action: "record_batch", file_changes: [{"file_path": "src/types.ts", "change_type": "modified", "layer": "data"}, {"file_path": "src/index.ts", "change_type": "modified", "layer": "infrastructure"}], atomic: true }'
    },
    documentation: {
    }
  };
